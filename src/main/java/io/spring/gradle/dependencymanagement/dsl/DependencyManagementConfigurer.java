...
/**
 * A {@code DependencyManagementConfigurer} provides methods for configuring dependency
 * management.
 *
...
public interface DependencyManagementConfigurer {
	...
	/**
	 * Configures the dependency management imports using the given {@code closure}. The
	 * closure is called with an {@link ImportsHandler} as its delegate.
	...
	/**
	 * Configures the managed dependencies using the given {@code closure}. The closure is
	 * called with {@link DependenciesHandler} as its delegate.
